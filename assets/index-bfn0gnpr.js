(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function n(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(o){if(o.ep)return;o.ep=!0;const r=n(o);fetch(o.href,r)}})();function v(){return`
  ...
  `}const x="http://localhost:8080";async function w(e){try{const t=await fetch(`${x}/api/bookings`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});if(!t.ok){const n=await t.json();throw new Error(n.message||"Failed to submit booking")}return await t.json()}catch(t){throw console.error("Booking API error:",t),t}}function k(){const e=document.getElementById("bookingForm");if(!e)return;const t=e.querySelectorAll(".step");let n=1;const i=d=>{t.forEach(l=>{l.classList.add("hidden"),l.classList.remove("block")});const s=e.querySelector(`[data-step="${d}"]`);s.classList.remove("hidden"),s.classList.add("block")};i(n);const o=document.getElementById("pickup"),r=document.getElementById("dropoff"),a=e.querySelector("select"),b=document.getElementById("date"),f=document.getElementById("time"),g=document.getElementById("name"),h=document.getElementById("phone"),y=document.getElementById("email");document.getElementById("nextBtn").onclick=()=>{if(!o.value||!r.value){alert("Please fill pickup and drop-off locations");return}n=2,i(n)},document.getElementById("backBtn").onclick=()=>{n=1,i(n)},e.onsubmit=async d=>{d.preventDefault();const s={event_type:a.value,pickup_location:o.value,dropoff_location:r.value,trip_date:b.value,pickup_time:f.value,full_name:g.value,phone:h.value,email:y.value};console.log("Payload sent to API:",s);try{const l=await w(s);console.log("Booking successful:",l),alert("Booking submitted successfully!"),location.hash="#/drivers"}catch(l){alert("Failed to submit booking: "+l.message)}}}const c={"/login":v,"/home":u,"/drivers":m};async function B(e){const t=document.getElementById("app");if((!e||e==="/")&&(e="/login"),!c[e]){t.innerHTML="<h2>404 – Page not found</h2>";return}if(e==="/drivers")try{const i=await(await fetch("https://jsonplaceholder.typicode.com/users")).json();t.innerHTML=m(i);return}catch{t.innerHTML="<p>Failed to load drivers.</p>";return}if(e==="/home"){t.innerHTML=u(),k();return}t.innerHTML=c[e]()}function p(){const t=window.location.hash.replace("#","")||"/login";B(t)}window.addEventListener("load",p);window.addEventListener("hashchange",p);"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/sw.js").then(()=>console.log("✅ Service Worker registered")).catch(e=>console.log("❌ Service Worker failed:",e))});document.addEventListener("DOMContentLoaded",()=>{const e=document.getElementById("updateBtn");e&&e.addEventListener("click",()=>{window.location.href=window.location.pathname+window.location.search})});
